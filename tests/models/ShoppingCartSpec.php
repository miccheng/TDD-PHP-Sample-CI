...
require_once dirname(__FILE__) . '/../../src/models/product.php';
require_once dirname(__FILE__) . '/../../src/models/cart_item.php';
require_once dirname(__FILE__) . '/../../src/models/shopping_cart.php';
